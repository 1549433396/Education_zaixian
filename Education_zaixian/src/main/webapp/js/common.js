                ...
                '<section class="dis e-login-ele">'+
                    ...
                    '<div>'+
                        '<ol class="e-login-options">'+
                            '<li>'+
                                '<input id="u-email" type="text" placeholder="请输入"  name="" value="" onkeyup="$(this).next().html(\'\');">'+
                                '<p class="lr-tip-wrap"></p>'+
                            '</li>'+
                            '<li>'+
                                '<input id="u-password" type="password" placeholder="请输"  name="" value="" onkeyup="$(this).next().html(\'\');">'+
                                '<p class="lr-tip-wrap"></p>'+
                            '</li>'+
                        '</ol>'+
...
function dialogRegister() {
	...
	$.ajax({
		...
		error : function(error) {
			$(".e-l-jy").html('<font class="fsize12 c-orange">请稍后再操作</font>');
		}
	});
}
