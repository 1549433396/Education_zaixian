...
<header id="header">
	<section class="container">
		<h1 id="logo">
			<a href="${ctx }/" title="${websitemap.web.company}"> <%-- 				<img src="<%=staticImage%>${logomap.logo.url}" width="100%" alt="${websitemap.web.company}"> --%>
				<img src="/images/upload/websiteLogo/20150820/1440035056371.png"
				width="100%" alt="${websitemap.web.company}">
			</a>
		</h1>
		<div class="h-r-nsl">
			<ul class="nav">
				<li><a href="/" title="首页"
					<c:if test="${indexNavigate.newPage==0}">target="_blank"</c:if>>首页</a></li>
				<li><a href="/course" title="课程"
					<c:if test="${indexNavigate.newPage==0}">target="_blank"</c:if>>课程</a></li>
				<li><a href="/teacher" title="名师"
			...
			<!-- / nav -->
			<ul class="h-r-login">
				<li class="undis" id="no-login"><a href="javascript:lrFun(1)"
				...
				<li class="mr10 undis" id="is-login-one"><a
					href="${ctx}/uc/letter" title="消息" id="headerMsgCountId"> <em
						class="icon18 news-icon">&nbsp;</em>
				</a><q class="red-point" style="display: none">&nbsp;</q></li>
				<li class="h-r-user undis" id="is-login-two"><a
					href="${ctx}/uc/index" title=""> <img
						src="${ctx }/static/inxweb/img/avatar-boy.gif" width="30"
...
<div class="head-mobile">
	<div class="head-mobile-box">
		<section class="clearfix">
			<div class="u-face-pic">
				<img src="${ctx }/static/inxweb/img/avatar-boy.gif" alt=""
					class="userImgPhoto"> <a href="${ctx }/uc/initUpdateUser/1"
		...
		<nav class="mw-nav">
			<ul class="clearfix">
				<c:forEach items="${navigatemap.INDEX}" var="indexNavigate">
					<li><a href="${ctx}${indexNavigate.url}"
						title="${indexNavigate.name}"
				...
				<li><span>Wo的学习</span>
					<ol>
						<li class="current"><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/index')" title="">免费课程</a></li>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/front/showcoulist')"
							title="">选课中心</a></li>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/myFavorites')" title="">Wo的收藏</a></li>
					</ol></li>
			</ul>
			<ul>
				<li><span>Wo的问答</span>
					<ol>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/myquestions/list')"
							title="">Wo的提问</a></li>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/myrepquestions/list')"
							title="">Wo的回答</a></li>
					</ol></li>
			</ul>
			<ul>
				<li><span>Wo的资料</span>
					<ol>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/initUpdateUser/0')"
							title="">基本资料</a></li>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/initUpdateUser/1')"
							title="">个人头像</a></li>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/initUpdateUser/2')"
							title="">密码设置</a></li>
					</ol></li>
			</ul>
			<ul>
				<li><span>Wo的消息</span>
					<ol>
						<li><a href="javascript:void(0)"
							onclick="mobileHrefCheckLogin('${ctx }/uc/letter')" title="">系统消息</a></li>
					</ol></li>
			</ul>
		</section>
	</div>
