		...
		<div class="larry-personal-body clearfix">
			...
			<div class="layui-form-item">
					...
					<div class="layui-input-block">  
						<input type="text" name="user_id"  class="layui-input " value="${list.user.login_name}"  autocomplete="off" disabled="disabled">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">邮箱</label>
					<div class="layui-input-block">  
						<input type="text" name="email"  class="layui-input " value="${list.email}"  autocomplete="off" disabled="disabled">
					</div>
				</div>
