	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			...
			<div class="larry-personal-body clearfix changepwd">
				<form class="layui-form col-lg-4" method="post" action="/admin/user_Edit">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="login_name" id="user_name"
								...
								class="layui-input" value="${user.login_name}" >
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="password" name="login_pwd" id="user_pwd" value=""
							  value="${user.login_pwd }"	autocomplete="off" class="layui-input" placeholder="请输入密码">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="user_name" id="user_name"
							 value="${user.user_name }"	autocomplete="off" placeholder="请输入用户真实姓名"
								class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="email" id="user_name"
							 value="${user.email }"	autocomplete="off" placeholder="请输入邮箱"
								class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="tel" id="user_name"
							 value="${user.tel }"	autocomplete="off" placeholder="请输入电话"
								class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
