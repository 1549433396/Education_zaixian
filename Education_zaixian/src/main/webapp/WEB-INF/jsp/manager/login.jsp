...
<div class="layui-layout layui-layout-login">
	...
	<div class="layui-user-icon larry-login">
		 <input type="text" placeholder="账号" id="uname" class="login_txtbx"/>
	</div>
	<div class="layui-pwd-icon larry-login">
		 <input type="password" placeholder="密码" id="upwd" class="login_txtbx"/>
	</div>
...
$(function(){
	...
	$(".submit_btn").click(function(){
		var uname = $("#uname").val();
		var upwd = $("#upwd").val();
	  location.href="/admin/login?uname="+uname+"&upwd="+upwd;
	});
});
</script>
</body>
