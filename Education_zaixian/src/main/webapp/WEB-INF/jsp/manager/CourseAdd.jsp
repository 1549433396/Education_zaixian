  ...
  function showPic(mypic){
	/*  if (mypic.value){
		...
		/*  var imgFile = mypic;
		 var fr = new FileReader();
		 fr.onload=function(){
			 $("#showimg").attr({ src: fr.result, alt: "图片预览",display:"inline-block" });
		 };
	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			...
			<div class="larry-personal-body clearfix">
				<form class="layui-form col-lg-5" action="/admin/addcourse"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="isAvaliable" lay-filter="aihao">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="currentPrice" autocomplete="off"
								class="layui-input" placeholder="课程销售价">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">有效期类型</label>
						<div class="layui-input-block">
							<select name="losetype" lay-filter="aihao">
								<option value=""></option>
					...
					<div class="layui-form-item">
						...
						<!-- 这个属性不用管 -->
						<input type="hidden" name="courseKpoint.teacherId" id="courseKpoint.teacherId" value="0" />
					...
					<div class="layui-form-item layui-form-text">
						...
						<input type="hidden" id="in" name="context" value="" />
							<!-- <textarea name="context" placeholder="既然选择了远方，便只顾风雨兼程；路漫漫其修远兮，吾将上下而求索" value=""
					...
					<div class="layui-form-item">
						<div class="layui-input-block">
							<input class="layui-btn" lay-submit="" lay-filter="demo1" id="btns" value="添加" >
