	...
	<form class="form-horizontal" method="post">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="button" class="btn btn-default" onclick="Fun()">修改</button>
...
function Fun() {
	...
	if (type_names != "" && s1 == "") {
		document.forms[0].action = "/admin/imagetype/edit";
