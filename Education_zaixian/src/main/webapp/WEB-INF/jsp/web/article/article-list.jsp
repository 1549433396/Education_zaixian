			...
			<section class="i-article">
				<div class="fl col-7">
					<section class="mr30">
									...
									<c:forEach var="article" items="${articleList }">
										<li>
											<aside class="i-article-pic">
												<img xSrc="<%=staticImage%>${article.image_url }"
													src="${ctx }/static/inxweb/img/default-img.gif"
													alt="${article.title }">
											</aside> <!-- ${ctx }/web/article/showInfor/${article.article_id } -->
											<h3 class="hLh30 txtOf">
												<a
													href="${ctx }/front/articleinfo/${article.article_id}.html"
												...
												<div class="fl">
													<span> <a class="noter-dy vam" title="回答"
														href="${ctx }/front/articleinfo/${article.article_id}.html">
															...
															onclick="addPraise('${article.article_id}',3)">
															<em class="icon18">&nbsp;</em>(<span
																class="addPraise${article.article_id}_3 praise_count">${article.praise_count }</span>)
														</tt>
													</span>
												</div>
											</section>
						...
						<!-- 公共分页 开始 -->
						<form action="${ctx }/front/articlelist" method="post"
							id="searchForm">
