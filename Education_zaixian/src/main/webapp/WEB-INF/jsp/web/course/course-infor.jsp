													...
													<c:forEach items="${parentKpointList }" var="parentKpoint" varStatus="index">
														<c:if test="${parentKpoint.kpoint_type==0 }"><!-- 文件目录 -->
															<li class="lh-menu-stair">
																...
																>
																	<c:forEach items="${parentKpoint.list}" var="sonKpoint">
																		<li class="lh-menu-second ml30"><a href="javascript:void(0)" <%-- onclick="playVideo('${sonKpoint.videoUrl }',this)" --%> onclick="getPlayerHtml(${sonKpoint.kpoint_id },${sonKpoint.is_free },this)" title="">
																				<span class="fr"> 
						...
						<div>
							...
							<section class="stud-act-list">
									<ul style="height: auto;">
										<li>
											<div class="u-face">
												<a href="${ctx }/front/teacher/${course.id }">
													<c:choose>
														<c:when test="${not empty course.pic_path }">
															<img src="<%=staticImage%>${course.pic_path }" width="50" height="50" alt="">
														</c:when>
														<c:otherwise>
											...
											<section class="hLh30 txtOf">
												<a class="c-333 fsize16 fl" href="${ctx }/front/teacher/${course.id }">${course.name }</a>
											</section>
											<section class="hLh20 txtOf">
												<span class="c-999">${course.education }</span>
											</section>
										</li>
									</ul>
