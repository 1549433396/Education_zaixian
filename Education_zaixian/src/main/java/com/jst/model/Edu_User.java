...
public class Edu_User {
	...
	public String toString() {
		return "ForntUser [user_id=" + user_id + ", mobile=" + mobile + ", email=" + email + ", class_id=" + class_id
				+ ", password=" + password + ", user_name=" + user_name + ", show_name=" + show_name + ", sex=" + sex
				+ ", age=" + age + ", create_time=" + create_time + ", is_avalible=" + is_avalible + ", pic_img="
				+ pic_img + ", banner_url=" + banner_url + ", msg_num=" + msg_num + ", sys_msg_num=" + sys_msg_num
